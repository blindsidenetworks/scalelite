...
RSpec.describe BigBlueButtonApiController, type: :request do
  ...
  xdescribe '#getMeetingInfo' do
    ...
    let(:url) {'https://test-1.example.com/bigbluebutton/api/getMeetingInfo?meetingID=test-meeting-1&checksum=7901d9cf0f7e63a7e5eacabfd75fabfb223259d6c045ac5b4d86fb774c371945'}
